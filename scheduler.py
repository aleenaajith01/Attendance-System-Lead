...
if __name__ == "__main__":
    # Schedule the tasks
    schedule.every().day.at("15:09").do(lambda: send_request(url1))  # Replace time as needed
    schedule.every().day.at("15:10").do(lambda: send_request(url2))  # Replace time as needed
    schedule.every().day.at("15:11").do(lambda: send_request(url3))
